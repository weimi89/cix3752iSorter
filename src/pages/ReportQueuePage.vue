      ...
      <VTable hover class="table-cards">
        ...
        <tbody>
          ...
          <tr v-for="r in list" :key="r.id">
            ...
            <td class="text-center"><VBtn v-if="r.status === 'failed'" size="small" variant="tonal" @click="retry(r.id)">{{ $t('common.retry') }}</VBtn></td>
          </tr>
        </tbody>
      </VTable>
      <VDivider />
